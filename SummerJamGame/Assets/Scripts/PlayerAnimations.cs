...
public class PlayerAnimations : MonoBehaviour
{
	...
	void Update(){
			...
			if(PlayerMovement.horizontalMove < PlayerMovement.verticalMove && PlayerMovement.verticalMove < 0 && PlayerMovement.horizontalMove < 0.9 && PlayerMovement.horizontalMove > -0.9){
				Anim.SetBool(AnimNameUp, false);
